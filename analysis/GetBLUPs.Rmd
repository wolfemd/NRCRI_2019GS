...
trials<-readRDS("/workdir/marnin/NRCRI_2019GS/NRCRI_ExptDesignsDetected_72719.rds")
phenos<-trials %>% 
      unnest(TrialData) %>% 
...
asModelsFit %<>% 
  ...
  unnest(fitAS)
saveRDS(asModelsFit,file="data/nrcri_blupsForCrossVal_72719.rds")
...
asModelsFit %<>%
      ...
      unnest(fitAS)
saveRDS(asModelsFit,file="data/nrcri_blupsForCrossVal_outliersRemoved_73019.rds")
```
